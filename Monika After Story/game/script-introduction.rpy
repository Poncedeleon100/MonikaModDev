...
label introduction:
    ...
    if persistent.monika_kill == True:
        ...
        m "Ok"
        m "ur mom gay lol?"
        m 1p "Why does my script say that?"
        m "Oh well somebody is gonna get deleted fuck"
        m 1i "Damn what's the next line?"
        m 1h "ur dad lesbian lol?"
        m "Who the fuck wrote this fucking script?"
